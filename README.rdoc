...
Directly maps ruby properties to <tt>model_name:id:field_name</tt> keys in redis.
Scalar, list and set properties are supported.

Values can be marshaled to/from <tt>Integer</tt>, <tt>Float</tt>, <tt>DateTime</tt>, <tt>JSON</tt>. See <tt>Redis::Model::Marshal</tt> for more info.
